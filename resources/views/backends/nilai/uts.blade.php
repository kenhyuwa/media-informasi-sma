          ...
          <div class="row">
            <div class="col-md-12 col-md-12 col-xs-12 col-sm-12">
              <div id="content" class="col-md-12 clearfix">
                ...
                <div class="bottom">
                  <center><h3>FORM NILAI UTS</h3></center><hr>
                </div>
                  <div class="row">
                  <!-- form -->
                        <!-- form start -->
                        {!! Form::open(array('action' => ['Admin\NilaiSiswaController@nilaiUts'])) !!}
                            ...
                            <table class="table table-bordered table-hover table-responsive">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="number" name="id_nilai[{{ $input->id_nilai }}]" value="{{ $input->uts }}" class="form-control">
                                  </td>
                                </tr>
                                @endforeach
                              </tbody>
