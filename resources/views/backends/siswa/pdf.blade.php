...
<html lang="en">
  <head>
    <title>{{ ucwords($identitas->nama_sekolah) }} | Data Siswa</title>
    <style type="text/css">
    ...
    <table border="1" cellspacing="0">
      <thead>
        <tr>
          ...
          <th width="40">NIS</th>
          <th width="90">Nama</th>
          <th width="75">Alamat</th>
          <th width="55">Jenis kelamin</th>
          <th width="70">No. telpon</th>
          <th width="55">Nama orang tua</th>
        </tr>
      </thead>
      <tbody>
      @foreach ($siswas as $siswa)
        <tr>
          ...
          <td>{{ str_replace("_"," ",$siswa->no_telp) }}</td>
          <td>{{ ucwords($siswa->nama_ortu_wali) }}</td>
        </tr>
        @endforeach
      </tbody>
    </table>
